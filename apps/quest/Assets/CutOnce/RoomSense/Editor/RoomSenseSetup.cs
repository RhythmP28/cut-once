...
{
    const string MatPath = "Assets/CutOnce/RoomSense/Resources/SheikahGlow.mat";
    ...
    /// <summary>Create a folder chain like "Assets/a/b" — AssetDatabase.CreateAsset will not.</summary>
